...
const DUMMY_CLUSTERS = [
  ...
  {
    id: 3, cluster_label: 2, cluster_title: "의학 교육 질 저하 우려 확산", cluster_count: 620,
    cluster_summary: "의대 정원 급증에 따른 교육 인프라 부족 문제가 수면 위로 떠오르고 있습니다. 실습 환경, 교수 인력, 병원 수련 시스템이 충분히 갖춰지지 않은 상태에서의 급격한 증원은 의학 교육의 질적 하락으로 이어질 수 있다는 전문가들의 경고가 잇따르고 있습니다.",
    leading_sources: [{source_name: '조선일보'}, {source_name: '동아일보'}, {source_name: 'JTBC'}],
    representative_comments: [
      {comment_id: 5, cmt_content: "숫자만 늘린다고 의료가 좋아지나요? 제대로 가르칠 환경부터 만들어야죠.", cmt_emotion: "비판"},
      {comment_id: 6, cmt_content: "교수 한 명이 학생 수십 명을 감당하면 교육의 질이 떨어질 수밖에 없습니다.", cmt_emotion: "우려"}
    ]
  }, {
    id: 4, cluster_label: 3, cluster_title: "지역 의료 불균형 해소 vs 수도권 집중 우려", cluster_count: 430,
    cluster_summary: "의대 증원의 핵심 명분인 지방 의료 격차 해소를 둘러싼 논쟁이 심화되고 있습니다. 지방 의대 정원 확대를 통해 지역 의료를 강화할 수 있다는 기대와, 결국 졸업 후 수도권 쏠림 현상만 가속화될 것이라는 반론이 팽팽히 맞서며 정책의 실효성에 의문이 제기되고 있습니다.",
    leading_sources: [{source_name: '경향신문'}, {source_name: 'YTN'}, {source_name: '한국일보'}],
    representative_comments: [
      {comment_id: 7, cmt_content: "지방에 의사가 늘어도 다 서울로 가면 무슨 소용인가요.", cmt_emotion: "회의"},
      {comment_id: 8, cmt_content: "지역 필수 의료에 정착하면 인센티브를 주는 방향으로 가야 한다고 봅니다.", cmt_emotion: "제안"}
    ]
  }
];
...
const DUMMY_FEATURE_MAPS = {
  cluster_0: [
    { id: 'p1', label: '사건 원인 집중', type: 'primary', top: '38%', left: '32%', color: '#3b82f6', desc: '의료 인력 부족 현상 분석' },
    { id: 's1', label: '필수의료 붕괴', type: 'secondary', top: '10%', left: '18%', ratio: 0.85 },
    { id: 's2', label: '정부 책임론', type: 'secondary', top: '55%', left: '48%', ratio: 0.65 },
    { id: 's3', label: '의료계 내부 갈등', type: 'secondary', top: '72%', left: '22%', ratio: 0.45 },
    { id: 's4', label: '의대 정원 2000명', type: 'secondary', top: '18%', left: '52%', ratio: 0.75 },
    { id: 's5', label: '전공의 집단 사직', type: 'secondary', top: '62%', left: '62%', ratio: 0.7 },
    { id: 's6', label: '군의관 긴급 배치', type: 'secondary', top: '20%', left: '70%', ratio: 0.4 },
    { id: 's7', label: '의료 수가 개편', type: 'secondary', top: '78%', left: '55%', ratio: 0.35 },
    { id: 's8', label: '교육 여건 부재', type: 'secondary', top: '45%', left: '72%', ratio: 0.5 },
  ],
  cluster_1: [
    { id: 'p2', label: '시민 불안 집중', type: 'primary', top: '38%', left: '28%', color: '#10b981', desc: '응급실 운영난과 시민 불안 분석' },
    { id: 's9', label: '응급실 뺑뺑이', type: 'secondary', top: '12%', left: '22%', ratio: 0.9 },
    { id: 's10', label: '의료 대란 본격화', type: 'secondary', top: '58%', left: '45%', ratio: 0.7 },
    { id: 's11', label: '상급종합병원 파행', type: 'secondary', top: '20%', left: '58%', ratio: 0.65 },
    { id: 's12', label: '야간 응급 마비', type: 'secondary', top: '70%', left: '20%', ratio: 0.55 },
    { id: 's13', label: '중증 환자 위험', type: 'secondary', top: '48%', left: '65%', ratio: 0.6 },
    { id: 's14', label: '시민 청원 급증', type: 'secondary', top: '75%', left: '58%', ratio: 0.4 },
    { id: 's15', label: '응급 병상 부족', type: 'secondary', top: '30%', left: '70%', ratio: 0.5 },
  ],
  cluster_2: [
    { id: 'p3', label: '의료계 내부 갈등', type: 'primary', top: '40%', left: '30%', color: '#ec4899', desc: '정부와 의료계 간 갈등 분석' },
    { id: 's16', label: '의대생 휴학 신청', type: 'secondary', top: '13%', left: '20%', ratio: 0.8 },
    { id: 's17', label: '교수진 사직 연대', type: 'secondary', top: '62%', left: '18%', ratio: 0.7 },
    { id: 's18', label: '의협 강경 노선', type: 'secondary', top: '20%', left: '55%', ratio: 0.65 },
    { id: 's19', label: '전공의 복귀 협상', type: 'secondary', top: '55%', left: '55%', ratio: 0.55 },
    { id: 's20', label: '병원장 중재 시도', type: 'secondary', top: '75%', left: '42%', ratio: 0.45 },
    { id: 's21', label: '전문의 과부하', type: 'secondary', top: '30%', left: '72%', ratio: 0.5 },
    { id: 's22', label: '의대 교육 질 논란', type: 'secondary', top: '65%', left: '68%', ratio: 0.4 },
  ],
  cluster_3: [
    { id: 'p4', label: '정책적 대응 분석', type: 'primary', top: '38%', left: '28%', color: '#f59e0b', desc: '정부의 정책 대응과 향후 전망 분석' },
    { id: 's23', label: '응급 대비 입법', type: 'secondary', top: '12%', left: '22%', ratio: 0.75 },
    { id: 's24', label: '의료법 개정 추진', type: 'secondary', top: '60%', left: '20%', ratio: 0.65 },
    { id: 's25', label: '복지부 강경 대응', type: 'secondary', top: '18%', left: '55%', ratio: 0.7 },
    { id: 's26', label: '정부 중재안 발표', type: 'secondary', top: '55%', left: '50%', ratio: 0.6 },
    { id: 's27', label: '국민 의료비 부담', type: 'secondary', top: '72%', left: '42%', ratio: 0.5 },
    { id: 's28', label: '외국 의료진 검토', type: 'secondary', top: '28%', left: '68%', ratio: 0.4 },
    { id: 's29', label: '의대 지방 분산', type: 'secondary', top: '62%', left: '65%', ratio: 0.45 },
    { id: 's30', label: '공공의대 설립안', type: 'secondary', top: '78%', left: '62%', ratio: 0.35 },
  ]
};
            ...
            <>
              ...
              {activeTab === 'feature' && (
                <div className="tab-feature fade-in">
                  ...
                  <div className="glass-card feature-map-bg" style={{minHeight:'600px', position:'relative', overflow:'hidden', width:'100%'}}>
